...
def genereaza_anagramele(lista_cuvinte):
    ""
" - structura de date in care tinem anagramele e un dictionar unde cheia e valoarea canonica a anagramei, iar valoarea e o lista ce contine toate aparitiile unei anagrame in lista de cuvinte - pentru a afla numarul de aparitii al unei anagrame, e suficient sa ne uitam la lungimea listei de aparitii - "
valoarea canonica "
a anagramei o consideram a fi cuvantul format din sortarea alfabetica a literelor anagramei, dupa ce aceasta a fost convertita la litere mici
    ""
"
...
anagrame = genereaza_anagramele(t1)# verificarea 1
if len(anagrame['aab']) == 4:
    print('aab apare de 4 ori ca anagrama in ', t1)# verificarea 2
...
anagrame = genereaza_anagramele(cuvinte)# printeaza_toate_anagramele(cuvinte)
